...
class MarktEventSourcing(
    ...
    createCommandHandlers: Collection<PickyCommandHandler<String, String, CommandContext, Pair<ErstelleMarkt, Vertrag>, Event, CommandValidation>>,
    ...
    val createCommandHandler: DelegatingCommandHandler<String, String, CommandContext, Pair<ErstelleMarkt, Vertrag>, Event, CommandValidation>
